...
class AddProductAdmin extends React.Component{
    ...
    componentDidMount(){
        axios.get(`http://localhost:2000/productAdmin/productCategories`)
        .then(res =>{
    ...
    addProduk =()=>{
        ...
        if(!idproduct_category || !name || !desc || !capital || !price || !stock || !photo){
        ...
        axios.post(`http://localhost:2000/productAdmin/addProductAdmin`, data)
        .then(res =>{
          this.setState({idproduct : res.data.idproduct})
          axios.post(`http://localhost:2000/productAdmin/editUploadProduct/${this.state.idproduct}/products`, photo, {headers:{'Content-Type' : 'multipart/form-data'}})
          .then(res => {
            this.setState({caption : "Data produk berhasil ditambahkan", successModal:true})
    ...
    render(){
        ...
        <input 
          ...
          <div style={{width:"40vw"}}>
            ...
            <Form.Control type="text" placeholder="masukkan nama Produk" ref="namaProduk" />
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
              ...
              <Form.Control placeholder="masukkan deskripsi produk" as="textarea" rows={4} ref="deskripsi" />
            </Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              <Form.Label>Harga Modal Produk</Form.Label>
              <Form.Control type="number" placeholder="masukkan Harga Modal" onChange={(e)=>this.setState({jual : (e.target.value * this.state.persen/100) + parseInt(e.target.value)})} ref="modal" />
            </Form.Group>
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Control type="number" placeholder="masukkan stok produk" ref="stok" />
            </Form.Group>
            <form enctype="multipart/form-data">
        <input 
            type="file"
        ...
        <Button variant="primary" style={{width:"15%", margin:"auto", marginTop:"2%", marginLeft:"55%"}} onClick={this.addProduk} >Tambah Produk</Button>
